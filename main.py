from vle.utils.callbacks import ImageLogger
...
if __name__ == "__main__":
    ...
    callbacks = [
        ...
        ImageLogger(
            log_dir_name,
            config["img_batch_frequency"],
            sample_intermediates=config["sample_intermediates"],
            sample_latent=config.get("sample_latent", False),
            downsample_factor=config.get("log_imgs_ds_factor", 0.25),
        ),
        ModelCheckpoint(
